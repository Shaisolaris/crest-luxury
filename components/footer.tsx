    ...
    <footer id="contact" className="bg-primary text-primary-foreground">
      <div className="max-w-[1800px] mx-auto px-6 md:px-12">
        ...
        <div className="py-16 md:py-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <p className="text-primary-foreground/70 text-sm leading-relaxed max-w-xs">
              Since 1847, we create exceptional pieces that celebrate
              timeless elegance and artisanal craftsmanship.
            </p>
          ...
          <div className="space-y-6">
            <h3 className="text-sm tracking-[0.2em] uppercase">Collections</h3>
            <ul className="space-y-3 text-sm text-primary-foreground/70">
              <li>
                <Link href="#" onClick={(e) => e.preventDefault()} className="hover:text-primary-foreground transition-colors duration-300">
                  Haute Couture
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-6">
            <h3 className="text-sm tracking-[0.2em] uppercase">The House</h3>
            <ul className="space-y-3 text-sm text-primary-foreground/70">
              <li>
                <Link href="#" onClick={(e) => e.preventDefault()} className="hover:text-primary-foreground transition-colors duration-300">
                  Our Story
        ...
        <div className="py-6 border-t border-primary-foreground/20 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/50">
          <p>© 2026 Maison Elegance. All rights reserved.</p>
